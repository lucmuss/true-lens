...
# Use link-based email verification to avoid confusion with any secondary code flows.
...
SECURE_REDIRECT_EXEMPT = env_list("DJANGO_SECURE_REDIRECT_EXEMPT", ["healthz/"])
